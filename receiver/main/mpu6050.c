...
//     printf("%02x:%02x:%02x:%02x:%02x:%02x, %d, %.7f, %.7f, %.7f, %.7f, %.7f, %.7f, %.7f\n", 
//             sample->mac[0], sample->mac[1], sample->mac[2], 
//             sample->mac[3], sample->mac[4], sample->mac[5],
//             sample->num, sample->ax, sample->ay, sample->az, 
//             sample->tp, sample->gx, sample->gy, sample->gz);
// }
...
// Converts from raw measurement to float.
// Does not bring MAC address, as this memcpy is done back in main.
